...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
  ...
  <url><loc>https://coachaisoccer.com/progress</loc><changefreq>monthly</changefreq><priority>0.6</priority></url>
  <url><loc>https://coachaisoccer.com/plan</loc><changefreq>monthly</changefreq><priority>0.5</priority></url>
</urlset>"""
...
> Free AI-powered session planner for volunteer youth soccer coaches. Generates complete 60-90 minute training sessions in seconds — warmup, drills, small-sided game, and cooldown — with step-by-step instructions written for parents who have never coached before.

## Public pages

- Home / Session Planner: https://coachaisoccer.com/
- How It Works / Progress: https://coachaisoccer.com/progress

## What CoachAI does

- Takes age group (U6–U16), number of players, session duration, and a focus skill
- Returns a structured 5-section session plan with coaching cues and setup instructions
- Plans are generated by Claude AI and rated on age-appropriateness and coaching quality
